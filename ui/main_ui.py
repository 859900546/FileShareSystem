...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.Heartbert = websocket_client.loop_connect()
    ...
    def init(self):
        ...
        self.Heartbert.log.connect(self.heartbert_check)
    ...
    def heartbert_check(self, log):
        if log:
            self.ui.label_5.setText('H:' + str(self.Heartbert_cnt))
            self.Heartbert_cnt += 1
            self.Heartbert_cnt %= 10
            self.ui.label_5.setStyleSheet('color:rgb(0,200,0)')
        else:
            self.ui.label_5.setText('W:' + str(self.Heartbert_cnt))
            self.Heartbert_cnt += 1
            self.Heartbert_cnt %= 10
            self.ui.label_5.setStyleSheet('color:rgb(200,0,0)')
